...
class LMForwardAPI:
    def __init__(self, model_name='vicuna', eval_data=None, init_prompt=None, init_qa=None, conf=None, base_conf=None,
        ...
        self.eval_template = template.EvalTemplate("Q: [INPUT]\nA: [PROMPT].\n\n[OUTPUT]") # change the evaluation template
    ...
    def eval(self, prompt_embedding=None, test_data=None):
        ...
        instruction[0] = 'Instruction: ' + instruction[0]
        start = instruction[0].find('Instruction: ')
        ...
        search_string = 'Instruction: '
        for sentence in sentences:
            if sentence.startswith(search_string):
                instruction[0] = sentence
                break
        
        instruction[0] = instruction[0].replace('Instruction: \n', '')
        instruction[0] = instruction[0].replace('Instruction: ', '')
        instruction[0] = instruction[0][0].upper() + instruction[0][1:]
...
def run(task, n_prompt_tokens, HF_cache_dir, nu, lamdba, n_init, n_domain, total_iter, local_training_iter, random_proj, intrinsic_dim, n_eval, gpt, init_scale, pooling):
    ...
    init_prompt = ['\n']
    # prompt_gen_template = "I have some instruction examples for solving school math problems.\n\nInstruction: \nLet’s figure it out!\n\nInstruction: \nLet’s solve the problem.\n\nInstruction: \nLet’s think it step by step.\n\n Write your new instruction that is similar in semantics as the examples to solve the school math problem.\n\n Instruction: "
    # best now is as below
    prompt_gen_template = "I have some instruction examples for solving school math problems.\n\nInstruction: \nLet’s figure it out!\n\nInstruction: \nLet’s solve the problem.\n\nInstruction: \nLet’s think step by step.\n\n Write your new instruction that is different from the examples to solve the school math problem.\n\n Instruction: "
    # prompt_gen_template = "I have some instruction examples for solving school math problems.\n\nInstruction: \nLet’s figure it out!\n\nInstruction: \nLet’s solve the problem.\n\nInstruction: \nLet’s think step by step.\n\n Write your new instruction that is different from the examples and the objective is to solve school math problem correctly.\n\n Instruction: "
    # prompt_gen_template = "I have a instruction for solving shcool math problems as follows:\n\n [full_DEMO]\n\nThe instruction was to"
    # prompt_gen_template = "I want to find a instructions for solving math problems as follows:\n\n[full_DEMO]\n\nSome possible instructions are as follows:\n\nInstruction: \nLet’s figure it out!\n\nInstruction: \nLet’s solve the problem.\n\nInstruction: \nLet’s think step by step.\n\nWrite your new instruction that is different from the previous ones.\n\nInstruction: "
    ...
    conf = {
        ...
        'evaluation': {
            ...
            'task': task,
            'num_samples': min(500, len(eval_data[0])),
            'model': {
                'gpt_config': {
                    'model': gpt
                }
    ...
    # prompts = ["Let’s think step by step"]
    ...
    test_conf = {
        ...
        'evaluation': {
            ...
            'task': task,
            'num_samples': min(2000, len(test_data[0])),
            'model': {
                "name": "GPT_forward",
                'gpt_config': {
                   'model': gpt
